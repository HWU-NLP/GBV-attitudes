...
def get_dirs(alpaca_format, dataset, feature_name, model_name, answer_type, use_demo):
    ...
    wandb_run_name = f"gbv_ft600_mistral_{feature_name}-{name}"
...
if __name__ == "__main__":
    ...
    parser.add_argument("--num_epochs", type=int, default=4, help=" total number of training epochs, set 100 for samples")
